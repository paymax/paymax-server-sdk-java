...
public interface PaymaxService {
     ...
     * @param request 请求细节
     * @param openId  微信用户的openId
     * @return paymax 唯一支付订单号; credential.wechat_wap.jsApiParams
     * @see #javascriptForWechatCharge(Charge)
     */
    Charge createWechatCharge(AppInfo app, ChargeRequest request, String openId) throws PaymaxException, IOException;
     ...
     * @see #javascriptForWechatCharge(Charge)
     */
    Charge createWechatCharge(ChargeRequest request, String openId) throws PaymaxException, IOException;

    /**
     * @param charge 订单
     * @return 用于在网页中完成支付的脚本代码
     */
    String javascriptForWechatCharge(Charge charge);
